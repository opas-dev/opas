// ABOUTME: Declares Cloudflare bindings and runtime APIs generated from wrangler.jsonc.
// ABOUTME: Gives D1, Workers AI, Email Sending, secrets, and OpenNext exact platform types.
/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: d1b93e511c7f2e8515654aca46f5c0b0)
// Runtime types generated with workerd@1.20260826.1 2026-08-27 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	OPAS_GENERATION_RETENTION_DISCLOSURE: "Answer analytics retain configured redacted conversation records for up to 30 days; explicit support handoffs retain contact and bounded context separately. Cloudflare AI Gateway logging is disabled and response caching is bypassed.";
	...
	OPAS_PREVIEW_SIGNING_SECRET: string;
...
interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "OPAS_DATABASE_DRIVER" | "OPAS_ANSWER_DAILY_BUDGET_MICRODOLLARS" | "OPAS_ANSWER_ANALYTICS_RETENTION_DAYS" | "OPAS_ANSWER_INPUT_MICRODOLLARS_PER_MILLION_TOKENS" | "OPAS_ANSWER_LEASE_MILLISECONDS" | "OPAS_ANSWER_MAXIMUM_CONCURRENCY" | "OPAS_ANSWER_MAXIMUM_INPUT_TOKENS" | "OPAS_ANSWER_OUTPUT_MICRODOLLARS_PER_MILLION_TOKENS" | "OPAS_GENERATION_GATEWAY_ID" | "OPAS_GENERATION_MODEL" | "OPAS_GENERATION_RETENTION_DISCLOSURE" | "OPAS_ANALYTICS_REDACTION_PATTERNS" | "OPAS_EMBED_PARENT_ORIGINS" | "OPAS_HANDOFF_DAILY_LIMIT" | "OPAS_HANDOFF_FROM_EMAIL" | "OPAS_HANDOFF_PROVIDER" | "OPAS_HANDOFF_RETENTION_DAYS" | "OPAS_PUBLIC_PROFILE" | "OPAS_SITE_URL" | "ADMIN_SESSION_SECRET" | "OPAS_PREVIEW_SIGNING_SECRET" | "OPAS_HANDOFF_TO_EMAIL">> {}
}
