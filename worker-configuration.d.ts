// ABOUTME: Declares the Cloudflare bindings and runtime APIs generated from wrangler.jsonc.
// ABOUTME: Gives the D1 adapter and OpenNext worker exact platform types.
/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 227aa9ba9846f298324d16e8c9985ed6)
...
interface __BaseEnv_CloudflareEnv {
	...
	OPAS_SITE_URL: "https://opas-mvp.timo-bejan.workers.dev";
	DATABASE_URL: string;
	VERCEL_TOKEN: string;
	ADMIN_EMAIL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "OPAS_DATABASE_DRIVER" | "OPAS_SITE_URL" | "DATABASE_URL" | "VERCEL_TOKEN" | "ADMIN_EMAIL" | "ADMIN_PASSWORD" | "ADMIN_SESSION_SECRET" | "NEON_DATABASE_URL">> {}
}
