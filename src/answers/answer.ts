...
const answerInstructions = [
  ...
  "First identify which evidence statements directly answer the question.",
  ...
  "If two or more equally current statements directly answer the question with incompatible facts, return exactly: ABSTAIN conflicting-evidence",
  "Different limits, prices, dates, names, or yes/no answers for the same subject are incompatible. Never choose one side of that conflict.",
  "Statements about other topics cannot create a conflict. If one statement fully answers the question and the others do not address it, use the answering statement.",
