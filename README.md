...
Ticketing/inbox, live-agent chat, autonomous support actions, arbitrary custom-block editing, real-time collaboration, multi-language authoring, and multi-tenancy remain outside the current scope.
